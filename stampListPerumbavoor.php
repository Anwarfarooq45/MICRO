...
<div class="navbar">
  ...
  <div class="cover">
  <a href="displayAreaWise.php?quarter=A&taluk=perumbavoor"><button id="quarterA">Quarter A</button></a>
  <a href="displayAreaWise.php?quarter=B&taluk=perumbavoor"><button id="quarterB">Quarter B</button></a>
  <a href="displayAreaWise.php?quarter=C&taluk=perumbavoor"><button id="quarterC">Quarter C</button></a>
  <a href="displayAreaWise.php?quarter=D&taluk=perumbavoor"><button id="quarterD">Quarter D</button></a>
</div>  
